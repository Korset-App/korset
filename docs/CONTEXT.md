...
**Catalog Golden Master (2026-09-24):** Единый чистый каталог на 40,000–60,000+ товаров FMCG. Основа — штрихкоды EAN-13, названия, 700x700 фото и RU/KZ составы из `semeiniy.kz`. Обогащение — консенсус 8 сетей (Arbuz, Vkusmart, Astykzhan, Clevermarket, Galmart, Interfood, Dina/Korzina) + OFF + KDV. Очистка Supabase (бэкап и дроп старых v2/v3/aliases, освобождение 380 МБ). Детали: `docs/vault/plans/2026-09-24-master-catalog-v4-execution-handoff.md`, `docs/vault/knowledge/2026-09-24-multi-source-catalog-pipeline-architecture.md`.

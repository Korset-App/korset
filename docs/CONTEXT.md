...
- ✅ **Парсинг подкатегории «Орехи и сухофрукты»**: Успешно завершен боевой импорт (89 уникальных EAN-продуктов из 106 обнаруженных на глубоких страницах 5 подкатегорий, 88 EAN-кодов получено через Нацкаталог РК, 77 создано с нуля, 12 обогащено деталями).
